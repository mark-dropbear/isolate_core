...
void main() {
  group('RdfResourceStorage', () {
    ...
    test('saveResource() persists to file', () async {
      ...
      await storage.saveResource(Vocab.getResourceIri('things/1'), thing.toDataset());
    ...
    test('getResource() retrieves existing dataset', () async {
      ...
      final retrieved = await storage.getResource(Vocab.getResourceIri('things/1'));
      ...
      final missing = await storage.getResource(Vocab.getResourceIri('things/2'));
    ...
    test('updateResource() applies partial updates', () async {
      ...
      await storage.updateResource(Vocab.getResourceIri('things/1'), update.toDataset(), updatePredicates: {Vocab.displayName});

      final updated = await storage.getResource(Vocab.getResourceIri('things/1'));
